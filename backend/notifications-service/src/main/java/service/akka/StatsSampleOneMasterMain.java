        ...
        for (String port : ports) {
            ...
            Config config =
                    ConfigFactory.parseString("akka.remote.classic.netty.tcp.port=" + port)
                            ...
                            .withFallback(ConfigFactory.load("notificationService"));
            ...
            system.actorOf(
                    ClusterSingletonManager.props(
                            Props.create(NotificationService_Cluster_Actor.class), PoisonPill.getInstance(), settings),
                    "notificationService");
            // #create-singleton-manager
            ...
            system.actorOf(
                    ClusterSingletonProxy.props("/user/notificationService", proxySettings), "notificationServiceProxy");
            // #singleton-proxy
        }
    }
}
